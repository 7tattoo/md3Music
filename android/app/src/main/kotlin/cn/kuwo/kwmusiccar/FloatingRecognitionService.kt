...
class FloatingRecognitionService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "cn.kuwo.kwmusiccar.RECOG_START"
        const val ACTION_STOP = "cn.kuwo.kwmusiccar.RECOG_STOP"
        const val ACTION_CONTINUE = "cn.kuwo.kwmusiccar.RECOG_CONTINUE"
        const val ACTION_STOP_CAPTURE = "cn.kuwo.kwmusiccar.RECOG_STOP_CAPTURE"
        const val ACTION_SET_RESULT = "cn.kuwo.kwmusiccar.RECOG_SET_RESULT"
        const val ACTION_SET_STATUS = "cn.kuwo.kwmusiccar.RECOG_SET_STATUS"
        const val ACTION_SET_THEME = "cn.kuwo.kwmusiccar.RECOG_SET_THEME"
        const val EXTRA_RESULT = "result"
        const val EXTRA_STATUS = "status"
        const val EXTRA_THEME_COLORS = "themeColors"
        const val DART_CHANNEL = "cn.kuwo.kwmusiccar/floating_recognition"
