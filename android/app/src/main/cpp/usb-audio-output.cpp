...
Java_com_tencent_wecarflow_UsbAudioStream_nativeUsbAudioCreate(
...
Java_com_tencent_wecarflow_UsbAudioStream_nativeUsbAudioSetAltSetting(
...
JNIEXPORT jboolean JNICALL
Java_com_tencent_wecarflow_UsbAudioStream_nativeUsbAudioSetSampleRate(
...
JNIEXPORT jboolean JNICALL
Java_com_tencent_wecarflow_UsbAudioStream_nativeUsbAudioStart(
...
Java_com_tencent_wecarflow_UsbAudioStream_nativeUsbAudioWrite(
...
JNIEXPORT void JNICALL
Java_com_tencent_wecarflow_UsbAudioStream_nativeUsbAudioStop(
        JNIEnv *, jobject, jlong h) {
    auto *ctx = reinterpret_cast<UsbAudioContext *>(h);
    if (!ctx) return;
    ctx->running.store(false);
...
JNIEXPORT void JNICALL
Java_com_tencent_wecarflow_UsbAudioStream_nativeFlush(
        JNIEnv *, jobject, jlong h) {
    auto *ctx = reinterpret_cast<UsbAudioContext *>(h);
    if (!ctx) return;
    ctx->frameAccumulator = 0.0;
...
Java_com_tencent_wecarflow_UsbAudioStream_nativeDrainUrbs(
        JNIEnv *, jobject, jlong h) {
    auto *ctx = reinterpret_cast<UsbAudioContext *>(h);
    if (!ctx) return 0;
    ctx->running.store(false);
...
JNIEXPORT void JNICALL
Java_com_tencent_wecarflow_UsbAudioStream_nativeUsbAudioDestroy(
        JNIEnv *, jobject, jlong h) {
    auto *ctx = reinterpret_cast<UsbAudioContext *>(h);
    if (!ctx) return;
    ctx->running.store(false);
...
JNIEXPORT jboolean JNICALL
Java_com_tencent_wecarflow_UsbAudioStream_nativeIsRunning(
        JNIEnv *, jobject, jlong h) {
    auto *ctx = reinterpret_cast<UsbAudioContext *>(h);
    if (!ctx) return JNI_FALSE;
...
JNIEXPORT jlong JNICALL
Java_com_tencent_wecarflow_UsbAudioStream_nativeGetFramesWritten(
        JNIEnv *, jobject, jlong h) {
    auto *ctx = reinterpret_cast<UsbAudioContext *>(h);
    if (!ctx) return 0;
...
JNIEXPORT jint JNICALL
Java_com_tencent_wecarflow_UsbAudioStream_nativeUsbReset(
 ...
 */
JNIEXPORT jint JNICALL
Java_com_tencent_wecarflow_UsbAudioStream_nativeUsbReconfigure(
        JNIEnv *, jclass, jint fd) {
...
JNIEXPORT void JNICALL
Java_com_tencent_wecarflow_UsbAudioStream_nativeUsbAudioWriteRaw(
