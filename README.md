...
- **听书** - 有声书专辑浏览、每日/每周/VIP 推荐，章节在线播放
...
- **MV 播放** - 在线 MV 播放，支持一键投屏到 DLNA 设备
...
- **我的收藏** - 本地收藏 + 云端同步，歌单/专辑支持长按批量多选删除
- **播放历史** - 自动记录，支持筛选已缓存歌曲
- **听歌排行** - 最近一周/全部累计听歌排行
- **听歌识曲** - 录音识别当前播放歌曲
...
- **主页 Tab 管理** - 一级页面 Tab 显示/隐藏与拖拽排序
- **歌词设置** - 字体选择、高斯模糊、辉光、动态颜色、省电模式、双击跳转、歌词字体自定义
