      ...
      children: [
        ...
        if (_lyricPushProtocol == 'lyric_info')
          SwitchListTile(
            ...
            subtitle: const Text(
              '按 ColorOS-Live-Lyrics-Bridge 协议输出（lyric 纯 LRC + rawLyric 逐字），'
              '开启后息屏歌词逐字高亮等增强可用',
            ),
        ...
        SwitchListTile(
          ...
          subtitle: const Text('锁屏时全屏显示滚动歌词，与播放页 Zen 沉浸模式一致（熄灭屏幕后点亮，覆盖在系统锁屏上方；解锁自动关闭；需要在权限管理同时开启锁屏通知和后台弹出界面以及显示悬浮窗权限才能显示）'),
    ...
    return Column(
      children: [
        ...
        ListTile(
          ...
          subtitle: const Text('蝰蛇官方与社区音效，浏览并下载音效文件'),
          trailing: const Icon(Icons.chevron_right),
          onTap: () => Navigator.push(
            context,
