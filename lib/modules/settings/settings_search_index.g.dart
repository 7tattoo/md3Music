...
const List<({String label, String category, String aliases})>
  ...
  (label: '面板宽度', category: '外观', aliases: ''),
  ...
  (label: '3D 封面', category: '播放页样式', aliases: '3D 封面;深度;视差;立体;封面'),
  (label: '3D 封面强度', category: '播放页样式', aliases: '3D 封面 强度;视差 灵敏度;陀螺仪 灵敏度;深度 幅度'),
  (label: '导入深度模型', category: '播放页样式', aliases: '3D 封面 模型;导入 模型;深度模型;onnx'),
  (label: '清理深度图缓存', category: '播放页样式', aliases: '3D 封面 缓存;清理 缓存;深度 缓存'),
  ...
  (label: '横屏隐藏状态栏', category: '播放', aliases: '横屏 沉浸 状态栏 导航栏 隐藏 全屏播放器'),
  (label: '关闭本地音乐评论区', category: '播放', aliases: '本地音乐 评论区 评论 tab 看评论 关闭评论 本地歌曲'),
  ...
  (label: '显示 MV 弹幕', category: '播放', aliases: 'MV 弹幕 弹幕 视频 滚动'),
  (label: '弹幕透明度', category: '播放', aliases: '弹幕透明度 弹幕 浓度'),
  ...
  (label: 'TPDF 抖动降位', category: 'USB 独占', aliases: 'tpdf 抖动 dither 降位 量化 32bit 位深'),
  (label: '主页 Tab 管理', category: '主页管理', aliases: 'tab 标签页 主页'),
  (label: '桌面快捷方式', category: '桌面快捷方式', aliases: '快捷方式 快捷 长按'),
  (label: '本地数据接口', category: '缓存与数据', aliases: '接口 本地服务器 api 在线音乐'),
  ...
  (label: '新版本提醒', category: '关于', aliases: '更新 新版本 升级 upgrade 提醒'),
